...
class Sales_Exception(Exception): ## Inheriting the Exception class 
    ...
    def __init__(self,error_message:Exception, error_detail:sys):
        ...
        self.error_message=Sales_Exception.get_detailed_error_message(error_message=error_message,
    ...
    def __repr__(self)-> str:
        return Sales_Exception.__name__.str()