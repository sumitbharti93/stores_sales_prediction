...
from stores_sales.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact
from stores_sales.entity.config_entity import ModelTrainerConfig
from stores_sales.util.util import load_numpy_array_data,save_object,load_object
from stores_sales.entity.model_factory import MetricInfoArtifact, ModelFactory,GridSearchedBestModel
from stores_sales.entity.model_factory import evaluate_regression_model



class Stores_sales_estimator:
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            housing_model = Stores_sales_estimator(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
